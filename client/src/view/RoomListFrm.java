...
public class RoomListFrm extends javax.swing.JFrame {
    ...
    public void updateRoomList(Vector<String> listData, Vector<String> listPassword) {
        ...
        for (int i = 0; i < listRoom.size(); i++) {
            if (listPassword.get(i).equals(" ")) {
                imageIcon = new ImageIcon("assets/icon/unlock.png");
            } else {
                imageIcon = new ImageIcon("assets/icon/lock.png");
            }
    ...
    private void initComponents() {
        ...
        setBackground(new java.awt.Color(176, 216, 230));
        ...
        jButton1.setBackground(new Color(255, 10, 10));
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(frameLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addComponent(jButton1, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE))
